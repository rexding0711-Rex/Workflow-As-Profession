...
| `{"running": true, "extension_connected": false, ...}` | Extension not connected. Tell the user: "Please make sure the Kimi WebBridge browser extension is installed and enabled. See https://www.kimi.com/features/webbridge (Chinese: https://www.kimi.com/zh-cn/features/webbridge) for instructions." |
...
| `extension_connected` stays `false` after app reopen | Browser extension not installed or disabled. Direct user to https://www.kimi.com/features/webbridge (Chinese: https://www.kimi.com/zh-cn/features/webbridge). |
